...
export class CoreServiceImpl extends CoreClientAware implements CoreService {
  ...
  >(
    ...
    //  - The `updatedUploadPort` port can be the "same" as the port before the upload. The CLI populates this field if the port has been cycled during the upload.
    //  - IDE2 always provides the `portAfterUpload`
