...
export namespace ArduinoMenus {
  ...
  export const FILE__PREFERENCES_GROUP = [...MAIN_MENU_BAR, '8_preferences'];
  ...
  export const SKETCH_COMMAND_ID = ['lingzhi-verify-sketch'];
  export const UPLOAD_SKETCH = ['lingzhi-upload-sketch'];
