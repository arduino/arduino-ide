...
export class Help extends Contribution {
  ...
  override registerCommands(registry: CommandRegistry): void {
    ...
    registry.registerCommand(
      ...
      createOpenHandler('http://lingzhilab.com/content.html')
    );
    ...
    registry.registerCommand(
      ...
      createOpenHandler('https://www.lingzhilab.com/')
    );
    registry.registerCommand(
...
export namespace Help {
  export namespace Commands {
    ...
    export const VISIT_ARDUINO: Command = {
      ...
      // label: nls.localize('arduino/help/visit', '访问 lingzhilab.com'),//原装
      label: nls.localize('arduino/help/visi', '访问 lingzhilab.com'),
      category: 'LingZhi',
    };
